...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  // Difficulty — these reference the difficulty selector setting (Easy/Medium/Hard/Expert),
  // not the country pool label (Flagship/Well-known/Familiar/Obscure).
  ...
  // Mastery — perfect runs on Expert difficulty (Obscure pool), 20 rounds, timer on, all correct.
  // "Expert difficulty" here means the difficulty selector setting; "Obscure pool" is the
  // country pool that setting activates — these are the same setting, named two ways.
  { id: 'perfect_banner',   name: 'Master Vexillologist',  description: 'Get a perfect score in The Banner Game — 20 rounds, Expert difficulty (Obscure pool), timer on.',      icon: '🏴', category: 'mastery' },
  { id: 'perfect_pin',      name: 'Eagle-Eyed Navigator',  description: 'Get a perfect score in The Pin Drop — 20 rounds, Expert difficulty (Obscure pool), timer on.',         icon: '📍', category: 'mastery' },
  { id: 'perfect_cart',     name: 'Flawless Cartographer', description: 'Get a perfect score in The Cartographer — 20 rounds, Expert difficulty (Obscure pool), timer on.',     icon: '🗺️', category: 'mastery' },
  { id: 'perfect_shape',    name: 'Shadow Reader',         description: 'Get a perfect score in The Silhouette — 20 rounds, Expert difficulty (Obscure pool), timer on.',       icon: '🌑', category: 'mastery' },
  { id: 'perfect_capital',  name: 'Capital Mastermind',    description: 'Get a perfect score in The Capital Cities — 20 rounds, Expert difficulty (Obscure pool), timer on.',   icon: '🏛️', category: 'mastery' },
  { id: 'perfect_region',   name: 'Continental Command',   description: 'Get a perfect score in The Continental — 20 rounds, Expert difficulty (Obscure pool), timer on.',      icon: '🌍', category: 'mastery' },
  { id: 'perfect_language', name: 'Supreme Linguist',      description: 'Get a perfect score in The Linguist — 20 rounds, Expert difficulty (Obscure pool), timer on.',         icon: '🗣️', category: 'mastery' },
  { id: 'perfect_province', name: 'Sovereign Surveyor',    description: 'Get a perfect score in The Province — 20 rounds, Expert difficulty (Obscure pool), timer on.',         icon: '📋', category: 'mastery' },
  // Prestige — meta-achievements awarded for completing entire achievement sets.
  { id: 'meridian_conqueror', name: 'Meridian Conqueror', description: 'Earn all 8 Mastery achievements — a flawless Expert run across every game mode.',                      icon: '🌐', category: 'prestige' },
